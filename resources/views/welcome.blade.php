            ...
            <div class="container">
                <div class="header-top-area">
                    <ul class="lab-ul left">
                        <li>
                            <i class="icofont-ui-call"></i> <span>+91 6378929435</span>
                        </li>
                        <li>
                            <i class="icofont-location-pin"></i> Jaipur, Rajasthan
                        </li>
                    </ul>
    ...
    <div class="news-footer-wrap">
        ...
        <footer>
            ...
            <div class="footer-bottom style-2">
                <div class="container">
                    <div class="section-wrapper">
                        <p>&copy; 2023 <a href="/">School</a> Designed by <a href="#" target="_blank">Rohit Bajiya</a> </p>
                    </div>
                </div>
            </div>
        </footer>
